[![Travis](https://img.shields.io/travis/rust-lang/rust.svg)]()    ![Travis](https://img.shields.io/badge/codedinR-working-blue.svg)
## DrugSideEffects
...
## This is work in progress and the existing R files will change and new ones will be added over the next few weeks.
#### `Ken McGarry, 25th April 2017.`
